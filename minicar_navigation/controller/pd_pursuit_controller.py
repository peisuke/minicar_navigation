#!/usr/bin/env python3
"""
PD Pure Pursuit Controller for Local Path Following
...
class PDPursuitControllerConfig:
...
class PDPursuitController(BaseController):
    """PD制御を用いたPure Pursuit アルゴリズムによるパス追従コントローラー"""
    
    def __init__(self, config: PDPursuitControllerConfig = None):
        """
        Args:
            config: コントローラー設定
        """
        self.config = config or PDPursuitControllerConfig()
